...
key.set('n', '<leader>fF', builtin.current_buffer_fuzzy_find, { silent = true, desc = 'Search fuzzy in currently buffer' })
...
key.set('n', '<leader>ta', builtin.autocommands, { silent = true, desc = 'Lists vim autocommands' })
key.set('n', '<leader>tb', builtin.current_buffer_tags, { silent = true, desc = 'Lists all of the tags on currently buffer' })
...
key.set('n', '<leader>th', builtin.search_history, { silent = true, desc = 'Lists searches that were executed recently' })
...
key.set('n', '<leader>tS', builtin.spell_suggest, { silent = true, desc = 'Lists spelling suggestions for the word under the cursor' })
key.set('n', '<leader>tt', builtin.tags, { silent = true, desc = 'Lists tags in current directory with tag location file preview' })
key.set('n', '<leader>tT', builtin.help_tags, { silent = true, desc = 'Lists available help tags and opens selected tag a new window' })
...
-- Live-server keymaps
-- ------------------------------------------------------------------------------------------------
key.set('n', ';t', ':ToggleTerm size=10 direction=horizontal name=Terminal<CR>',  { silent = true, desc = 'Neogen Comment' })
